...
from ServLisLab import views
from CnsrPac import views as viewCnsrPac
from rest_framework_simplejwt import views as jwt_views

router = routers.DefaultRouter()
router.register(r'SolexaLAb', views.SolexalabViewSet)
router.register(r'SolexaLAbCps', views.SolexalabcpsViewSet)
